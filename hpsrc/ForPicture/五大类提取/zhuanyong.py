...
def main():
    ...
    new_folder_name = "zhuangyong_json"
    ...
    # 定义JSON文件和输出文件名的映射
    files_mapping = {
        'a9_⼈部.json': 'ren_专用名词.json',
        'a30_⼝部.json': 'kou_专用名词.json',
        'a61_⼼部.json': 'xin_专用名词.json',
        'a76_⽋部.json': 'qian_专用名词.json',
        'a149_⾔部.json': 'yan_专用名词.json'
    }
