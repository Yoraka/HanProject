...
characters_files = [file for file in characters_files if os.path.basename(file).split('_')[0] in ['a9', 'a30', 'a61', 'a76', 'a149']]
...
# 降维
umap_reducer1 = umap.UMAP(n_neighbors=30, min_dist=0.2, n_components=100, random_state=42)
...
# 对部首向量进行UMAP降维
umap_reducer = umap.UMAP(n_neighbors=20, min_dist=0.2, n_components=2, random_state=24)
...
plot
print('saving')
plot.save("data_map_exampleA.html")
